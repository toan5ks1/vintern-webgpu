...
print(f"Deleting {path_in_repo} from {repo_id}...")
try:
    api.delete_file(path_in_repo=path_in_repo, repo_id=repo_id, repo_type="model")
    print("Deletion successful!")
except Exception as e:
    print(f"Deletion failed (might not exist): {e}")
